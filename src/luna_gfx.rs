// https://github.com/Sonicpineapple/Discrete
...
impl GfxData {
    pub fn new(cc: &eframe::CreationContext<'_>) -> Self {
        ...
        let param_buffer = device.create_buffer(&BufferDescriptor {
            ...
            size: std::mem::size_of::<ShaderParams>() as _,
    ...
    pub fn frame(&mut self, view_settings: &ViewSettings, sim_settings: &SimSettings, width: u32, height: u32) {
        // Resize texture if it needs to
        let params = ShaderParams::new(view_settings, sim_settings);
...
impl ShaderParams {
    pub fn new(
        ...
        view_settings: &ViewSettings, sim_settings: &SimSettings,
    ) -> Self {
        todo!();
        Self {}
